...
/**
 * This is the extension manager of the Cuppytrailhmc extension.
 */
public class CuppytrailhmcManager extends GeneratedCuppytrailhmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CuppytrailhmcManager.class.getName());
	 ...
	 */
	public static CuppytrailhmcManager getInstance()
	{
		return (CuppytrailhmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CuppytrailhmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CuppytrailhmcManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CuppytrailhmcManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CuppytrailhmcManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CuppytrailhmcManager called, current tenant: " + getTenant().getTenantID());
		}
	}
