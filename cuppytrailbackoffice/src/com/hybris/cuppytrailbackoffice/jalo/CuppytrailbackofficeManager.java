 ...
 */
public class CuppytrailbackofficeManager extends GeneratedCuppytrailbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CuppytrailbackofficeManager.class.getName());
	 ...
	 */
	public static CuppytrailbackofficeManager getInstance()
	{
		return (CuppytrailbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CuppytrailbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CuppytrailbackofficeManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CuppytrailbackofficeManager called.");
		}
	}
