...
/**
 * This is the extension manager of the Cuppytrailfrontend extension.
 */
public class CuppytrailfrontendManager extends GeneratedCuppytrailfrontendManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CuppytrailfrontendManager.class.getName());
	 ...
	 */
	public CuppytrailfrontendManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CuppytrailfrontendManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CuppytrailfrontendManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CuppytrailfrontendManager called, current tenant: " + getTenant().getTenantID());
		}
	}
