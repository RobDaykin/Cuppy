...
/**
 * This is the extension manager of the Cuppytrailcockpit extension.
 */
public class CuppytrailcockpitManager extends GeneratedCuppytrailcockpitManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CuppytrailcockpitManager.class.getName());
	 ...
	 */
	public static CuppytrailcockpitManager getInstance()
	{
		return (CuppytrailcockpitManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CuppytrailcockpitConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CuppytrailcockpitManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CuppytrailcockpitManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CuppytrailcockpitManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CuppytrailcockpitManager called, current tenant: " + getTenant().getTenantID());
		}
	}
