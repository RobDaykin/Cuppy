...
/**
 * Cuppy navigation area.
 */
public class CuppyNavigationArea extends BaseUICockpitNavigationArea
{
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(CuppyNavigationArea.class);
	...
	public SectionPanelModel getSectionModel()
	{
		...
		{
			final CuppyNavigationAreaModel model = new CuppyNavigationAreaModel(this);
			model.initialize();
