 ...
 *  
 */
package de.hybris.platform.cuppy.hmc;
...
/**
 * Provides necessary meta information about the cuppy hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class CuppyHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(CuppyHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "de.hybris.platform.cuppy.hmc.locales";
